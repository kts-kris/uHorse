...
<p align="center">
  <strong>v4.1.2 Hub-Node 主线发布</strong>
</p>
...
uHorse 当前对外发布口径是 **v4.1.2 Hub-Node 主线**。
...
当前文档以 **仓库里已实现并验证的行为** 为准，不再把旧版 `/health/live`、`/health/ready`、`/api/v1/auth/*`、`/api/v1/messages` 当作当前主线，也不把 `v4.1.2` 写成旧单体 Agent 平台回归。
...
| 文档 | 说明 |
|------|------|
| [CHANGELOG.md](CHANGELOG.md) | `v4.1.2` 发布事实、文档同步记录与当前非目标说明 |
...
| [RELEASE_NOTES.md](RELEASE_NOTES.md) | `v4.1.2` 发布说明 |
