...
uHorse 当前对外发布口径是 **v4.1.3 Hub-Node 主线**。
...
| 文档 | 说明 |
|------|------|
| [CHANGELOG.md](CHANGELOG.md) | `v4.1.3` 发布事实、文档同步记录与当前非目标说明 |
...
| [RELEASE_NOTES.md](RELEASE_NOTES.md) | `v4.1.3` 发布说明 |
